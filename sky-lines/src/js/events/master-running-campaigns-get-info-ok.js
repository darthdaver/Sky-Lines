...
exports.createEvent = function () { // add "options" parameter if needed
    return function (context, data) {
        ...
        if (!context.vms['master-edit-campaigns-container']) {
            ...
            context.vms['master-edit-campaigns-container'].init({mask: 'master-selected-running-campaign-details'});
        }
        ...
        context.vms['master-selected-running-campaign-details'].init({input : packet});
    };
};
