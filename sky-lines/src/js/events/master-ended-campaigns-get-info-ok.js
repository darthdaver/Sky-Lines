...
exports.createEvent = function () { // add "options" parameter if needed
    return function (context, data) {
        ...
        if (!context.vms['master-edit-campaigns-container']) {
            ...
            context.vms['master-edit-campaigns-container'].init({mask: 'master-selected-ended-campaign-details'});
        }
        ...
        context.vms['master-selected-ended-campaign-details'].init({input : packet});
    };
};
