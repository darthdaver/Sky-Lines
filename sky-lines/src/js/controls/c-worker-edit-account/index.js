...
ViewModel.prototype.id = 'worker-edit-account';
ViewModel.prototype.children = [
    'account-info-details-worker' // modify
    ,'worker-account-form' // account form
];

exports.register = function () {
    ko.components.register('c-worker-edit-account', {
        viewModel: {
