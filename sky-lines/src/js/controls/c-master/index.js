...
ViewModel.prototype.id = 'master';
ViewModel.prototype.children = [
    'master-box' // master box
    ,'manage-workers-modal' // workers modal
    ,'images-waiting-modal-container' // images modal
    ,'statistics-modal' // statistics modal
    ,'edit-campaign-modal' // edit campaign modal
];

exports.register = function () {
    ko.components.register('c-master', {
        viewModel: {
