...
ViewModel.prototype.id = 'master-create-campaign-container';
ViewModel.prototype.children = [
    'master-create-campaign-form' // create form
];

exports.register = function () {
    ko.components.register('c-master-create-campaign-container', {
        viewModel: {
