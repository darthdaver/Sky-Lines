...
ViewModel.prototype.id = 'master-selected-waiting-campaign-details';
...
ViewModel.prototype._compute = function() {
  ...
  if(this.filters.campaign_url != undefined){
    ...
    this._computing = this._repository.c_g_find('ready').then(function (items) {

      if(items.length > 0){

        self.context.events['master-selected-waiting-campaign'](self.context, items[0]);
      }
    });
  }
...
exports.register = function () {
    ko.components.register('c-master-selected-waiting-campaign-details', {
        viewModel: {
