...
function ViewModel(params) {
    ...
    self.select = function() {
        ...
        self.output = this;
        self.trigger.call(this, 'image-selected-statistics');
    };
...
ViewModel.prototype.id = 'images-statistics-list';
  ...
  if(self.filters.campaign_images_url != undefined){
    this._computing = this._repository.i_g_find_all(self.filters.campaign_images_url).then(function (items) {
      ...
      if (items[0]['images'].length > 0) {
        ...
        self.trigger.call(firstItem, 'image-selected-statistics');
      }
    ...
    self.trigger.call(packet, 'image-selected-statistics');
  }
...
exports.register = function () {
    ko.components.register('c-images-statistics-list', {
        viewModel: {
