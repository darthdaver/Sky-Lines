...
ViewModel.prototype.id = 'master-running-campaign-list-container';
ViewModel.prototype.children = [
    'master-running-campaigns-list' // running campaign list
];

exports.register = function () {
    ko.components.register('c-master-running-campaign-list-container', {
        viewModel: {
