...
ViewModel.prototype.id = 'statistics-modal';
ViewModel.prototype.children = [
    //'statistics-in-numbers' // statistics in number
    ,'images-statistics-list' // images statistics
];

exports.register = function () {
    ko.components.register('c-statistics-modal', {
        viewModel: {
