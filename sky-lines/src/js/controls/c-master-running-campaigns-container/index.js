...
ViewModel.prototype.id = 'master-running-campaigns-container';
ViewModel.prototype.children = [
    'master-running-campaign-selected-container' // Details
    ,'master-running-campaign-list-container' // Running Campaigns
];

exports.register = function () {
    ko.components.register('c-master-running-campaigns-container', {
        viewModel: {
