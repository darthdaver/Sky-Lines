...
ViewModel.prototype.id = 'master-edit-campaigns-container';
ViewModel.prototype.children = [
    'master-waiting-campaigns-container' // waiting campaigns
    ,'master-running-campaigns-container' // running campaigns
    ,'master-ended-campaigns-container' // ended campaigns
];

exports.register = function () {
    ko.components.register('c-master-edit-campaigns-container', {
        viewModel: {
