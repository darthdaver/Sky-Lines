...
ViewModel.prototype.id = 'master-selected-ended-campaign-details';
...
ViewModel.prototype._compute = function() {
    ...
    if(this.filters.campaign_url != undefined){
      ...
      this._computing = this._repository.c_g_find('ended').then(function (items) {

        if(items.length > 0){

          self.context.events['master-selected-ended-campaign'](self.context, items[0]);
        }
      });
    }
...
exports.register = function () {
    ko.components.register('c-master-selected-ended-campaign-details', {
        viewModel: {
