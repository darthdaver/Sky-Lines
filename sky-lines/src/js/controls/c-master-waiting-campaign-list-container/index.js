...
ViewModel.prototype.id = 'master-waiting-campaign-list-container';
ViewModel.prototype.children = [
    'master-waiting-campaigns-list' // waiting-campaigns-list
];

exports.register = function () {
    ko.components.register('c-master-waiting-campaign-list-container', {
        viewModel: {
