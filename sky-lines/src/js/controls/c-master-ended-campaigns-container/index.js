...
ViewModel.prototype.id = 'master-ended-campaigns-container';
ViewModel.prototype.children = [
    'master-ended-campaign-list-container' // Ended Campaigns
    ,'master-ended-campaign-selected-container' // Details
];

exports.register = function () {
    ko.components.register('c-master-ended-campaigns-container', {
        viewModel: {
