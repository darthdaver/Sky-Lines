...
exports.register = function(){
  ...
  ko.components.register('line-drawer', {
      viewModel: ViewModel,
      template: '<img width="500px" data-bind="attr: { src: src() }, LineDrawNaturalSize: naturalSize" class="background" draggable="false"/><canvas id="mycanvas" class="canvas" data-bind="LineDraw: line(), LineDrawSetSize: naturalSize, LineDrawPen: pen()"></canvas>'
  });
