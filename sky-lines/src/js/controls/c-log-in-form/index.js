...
ViewModel.prototype.id = 'log-in-form';
...
ViewModel.prototype._compute = function () {
    ...
    ids['password'] = "log-in-form_field_2_error";
    ids['username'] = "log-in-form_field_1_error";
    ...
    set_placeholder("log-in-form_field_2","Password","#fff");
    log_in_set_placeholder_red(ids,placeholders);
};
...
exports.register = function () {
    ko.components.register('c-log-in-form', {
        viewModel: {
