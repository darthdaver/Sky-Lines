...
ViewModel.prototype.id = 'master-ended-campaign-list-container';
ViewModel.prototype.children = [
    'master-ended-campaigns-list' // ended-campaigns-list
];

exports.register = function () {
    ko.components.register('c-master-ended-campaign-list-container', {
        viewModel: {
