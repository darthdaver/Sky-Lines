...
ViewModel.prototype.id = 'master-waiting-campaigns-container';
ViewModel.prototype.children = [
    'master-waiting-campaign-list-container' // Waiting Campaigns
    ,'master-waiting-campaign-selected-container' // Details
];

exports.register = function () {
    ko.components.register('c-master-waiting-campaigns-container', {
        viewModel: {
